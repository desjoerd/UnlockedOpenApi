...
namespace Unlocked.Client.Locks.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \locks\{lockId}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithLockItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Unlocked.Client.Locks.Item.WithLockItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithLockItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/locks/{lockId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Unlocked.Client.Locks.Item.WithLockItemRequestBuilder"/> and sets the default values.
...
#nullable enable
        public async Task<global::Unlocked.Client.Models.LockItem?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Unlocked.Client.Models.LockItem> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Unlocked.Client.Locks.Item.WithLockItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Unlocked.Client.Locks.Item.WithLockItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
