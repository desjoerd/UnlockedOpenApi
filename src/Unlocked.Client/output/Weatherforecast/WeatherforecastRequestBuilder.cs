...
namespace Unlocked.Client.Weatherforecast
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Unlocked.Client.Weatherforecast.WeatherforecastRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <returns>A List&lt;global::Unlocked.Client.Models.WeatherForecastResponse&gt;</returns>
...
#nullable enable
        public async Task<List<global::Unlocked.Client.Models.WeatherForecastResponse>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Unlocked.Client.Models.WeatherForecastResponse>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Unlocked.Client.Models.WeatherForecastResponse>(requestInfo, global::Unlocked.Client.Models.WeatherForecastResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Unlocked.Client.Weatherforecast.WeatherforecastRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Unlocked.Client.Weatherforecast.WeatherforecastRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Unlocked.Client.Weatherforecast.WeatherforecastRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
